package org.xbib.opensearch.plugin.bundle.index.mapper.icu;
...
import org.xbib.opensearch.plugin.bundle.index.analysis.icu.IndexableBinaryStringTools;
...
public class IcuCollationKeyFieldMapper extends FieldMapper {
    ...
    public static final class CollationFieldType extends StringFieldType {
        ...
        public Query fuzzyQuery(Object value, Fuzziness fuzziness, int prefixLength, int maxExpansions,
                                boolean transpositions, MultiTermQuery.RewriteMethod method, QueryShardContext context) {
            throw new UnsupportedOperationException();
        }
